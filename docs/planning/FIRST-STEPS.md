...
| Partial / HM-04-A | Typed graph, explicit Display/Write, alpha matte, opt-in linear-sRGB composition and format-6 profile migration are implemented | HM-01 | Qualify revision-safe cache/job publication, solve ordering and production cost before accepting HM-04 | HM-03; HM-10 is another eligible branch when a slot opens |
