...
| P08 | in_progress | Parented layers and typed character roots, pegs and parts; role editing, preserve-world rigid reparenting, stable rest pivots, named held substitutions, renderer-backed thumbnail browsing, coordinated view sets and independent character hierarchy copying with format-5 save/reopen. | Full rigid-character artistic acceptance, animated-ancestor reparenting, masked poses, Quick Rig, declarative controls, linked assets/templates and production-scale qualification. |
...
- HM-00 rigid baseline: 19 original sRGB PNG parts form a parented scene saved in the current format; save/reopen is semantically identical and the rendered first frame matches the checked-in 1080p reference. Generated dialogue cues and ten-minute drift markers pass exact sample-boundary checks. This verifies the registered-art baseline; separate HM-03 tests cover rigid substitutions and coordinated views, not a completed character shot.
